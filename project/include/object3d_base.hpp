...
public:
    ...
    void init_polar(const std::function<double(std::array<double, 3>)>& potential_function,
                    double x0, double y0, double z0, double level_value, double step,
                    double angle_step, tetra_type arg_tetra_type = tetra_type::transparent,
                    double tetra_v1 = 0, double tetra_v2 = 0);
